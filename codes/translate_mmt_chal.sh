...
cmd="fairseq-generate ~/scripts/chat_en_hi/data/wat2022_data/data_bin/visgenome.challenge 
  -s en -t hi 
  ...
  --output ~/scripts/multimodal/fairseq_mmt/checkpoints/visgenome/vit_base_patch16_224/vit_base_patch16_224-no_mask.freeze/hypo_challenge.txt" 
...
python3 rerank.py ~/scripts/multimodal/fairseq_mmt/checkpoints/visgenome/vit_base_patch16_224/vit_base_patch16_224-no_mask.freeze/hypo_challenge.txt ~/scripts/multimodal/fairseq_mmt/checkpoints/visgenome/vit_base_patch16_224/vit_base_patch16_224-no_mask.freeze/hypo_challenge.sorted
OUTFILENAME=/Data/baban/scripts/multimodal/fairseq_mmt/checkpoints/visgenome/vit_base_patch16_224/vit_base_patch16_224-no_mask.freeze/hypo_challenge.sorted
cat $OUTFILENAME | $MOSES_DIR/scripts/tokenizer/detokenizer.perl > $OUTFILENAME.hi
wc -l $OUTFILENAME.hi
cat $OUTFILENAME.hi | sacrebleu ~/scripts/chat_en_hi/data/wat2022_data/data/visgenome/challenge.hi  -m bleu ter
