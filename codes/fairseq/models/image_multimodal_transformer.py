...
@register_model("image_multimodal_transformer")
...
@register_model_architecture("image_multimodal_transformer", "image_multimodal_transformer")
...
@register_model_architecture("image_multimodal_transformer", "image_multimodal_transformer_top")
def image_multimodal_transformer_top(args):
...
@register_model_architecture("image_multimodal_transformer", "image_multimodal_transformer_top_samanantar")
def image_multimodal_transformer_top(args):
    args.encoder_embed_dim = getattr(args, "encoder_embed_dim", 512)
    args.encoder_ffn_embed_dim = getattr(args, "encoder_ffn_embed_dim", 2048)
    args.encoder_attention_heads = getattr(args, "encoder_attention_heads", 8)
...
@register_model_architecture("image_multimodal_transformer", "image_multimodal_transformer_top_4x")
def image_multimodal_transformer_top(args):
