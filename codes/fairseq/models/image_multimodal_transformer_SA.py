...
class TransformerEncoder(FairseqEncoder):
    ...
    def __init__(self, args, dictionary, embed_tokens):
        ...
        self.out = open("/Data/baban/scripts/multimodal" + '/gate.txt', 'w')
    ...
    def fuse_img_feat(self, text, idx, image, image_mask, text_mask):
        ...
        # mask = text_mask.unsqueeze(-1).expand(b, t, c)
...
@register_model_architecture("image_multimodal_transformer_SA", "image_multimodal_transformer_SA_top_samanantar")
def image_multimodal_transformer_SA_top(args):
    args.encoder_embed_dim = getattr(args, "encoder_embed_dim", 512)
    args.encoder_ffn_embed_dim = getattr(args, "encoder_ffn_embed_dim", 2048)
    args.encoder_attention_heads = getattr(args, "encoder_attention_heads", 8)
...
@register_model_architecture("image_multimodal_transformer_SA", "image_multimodal_transformer_SA_top_4x")
def image_multimodal_transformer_SA_top(args):
